...
public class Ship {
    ...
    private ArrayList<Integer> deckCoordinatesList = new ArrayList<>();
    ...
    public Ship(String coordinates) {
        ...
        for (String deckCoordinate : coordinatesArray) {
            deckCoordinatesList.add(Integer.parseInt(deckCoordinate.split(",")[0]));
            deckCoordinatesList.add(Integer.parseInt(deckCoordinate.split(",")[1]));
        }
    }
